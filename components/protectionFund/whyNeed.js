      ...
      <div className='container'>
        ...
        <div className='flex flex-col lg:flex-row gap-2 p-2 '>
            <div className='mt-14 mr-0 lg:mr-40 info-14-16 text-base'>
                <p>The Bitget Protection Fund gives our platform an extra layer of resilience against cybersecurity threats.</p>
                ...
                <p>If our customers have their accounts compromised or assets stolen or lost - not due to their own actions or trading behavior - then they may apply for a claim through the Bitget Protection Fund.</p>                
            </div>
