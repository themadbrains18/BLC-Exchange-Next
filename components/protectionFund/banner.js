    ...
    <section className='dark:bg-black-v-3 pb-20 pt-[120px] lg:pt-[120px]' >
        <div className='container flex items-center justify-between flex-col-reverse lg:flex-row gap-5  text-left'>
            <div className='flex flex-col gap-2'>
               ...
               <p className='info-14-20 mt-6 lg:mt-10'>We regularly monitor the Bitget Protection Fund, as well as crypto's cybersecurity landscape, to make sure that our fund remains adequate for our customers.</p>
            </div>
