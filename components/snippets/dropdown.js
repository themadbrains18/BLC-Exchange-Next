...
const {mode}=useContext(Context)
  ...
  return (
    <>
      <div className="p-4 absolute top-[100.6%] shadow-2xl group-hover:animate-open bg-white rounded-xl opacity-0 group-hover:opacity-100 overflow-x-auto h-[358px] dark:bg-black-v-4">
        {subMenu.map((e, index) => {
          return (
            <div
              key={index}
            ...
            >
              ...
              <div className="grow">
                <h3 className="info-14-16">{e.heading}</h3>
