...
const NotificationHover = () => {
  ...
  return (
    <>
      <div className="p-4 absolute top-[94%] invisible shadow-2xl group-hover:animate-open bg-white rounded-xl opacity-0 group-hover:opacity-100 group-hover:visible overflow-x-auto h-[358px] right-0 dark:bg-black-v-4">
