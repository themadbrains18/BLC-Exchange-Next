  ...
  return (
    <>
        <form className="flex items-center gap-3 max-w-[485px] w-full mt-8 mx-auto md:mx-0 flex-col md:flex-row	">
            <input type="email" className="block px-4 max-w-full md:max-w-[70%] w-full bg-transparent border  border-black dark:border-white rounded min-h-[46px] text-black dark:text-white outline-none focus:!border-primary" name="email" placeholder="Email Address" />
            <button className='cta max-w-full md:max-w-[27%] w-full' type='submit'>Sign up</button>
        </form>
