        ...
        <section className=' '>
            <div className='blue-gradient-active p-6 flex flex-col rounded-2xl'>
                <div className='flex justify-between'>
                    <p className='info-14-20'>Exclusive for new users</p>
                ...
                <div className='text-center'>
                    <span className='info-14-20'>Earn up to <span className='text-[#FFB800]'>5000 USDT</span>  for your first deposit</span>
                </div>
                    <button className=' info-14 bg-primary text-white w-full text-center inline-block mt-2 rounded-md py-2 px-4'>Get Started</button>
