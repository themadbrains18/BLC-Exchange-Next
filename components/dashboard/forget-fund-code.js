          ...
          <div className="p-0 sm:p-6 max-w-full md:max-w-[500px] w-full mx-0 md:mx-auto" >
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="mt-[24px]">
                ...
                <input type="text" {...register('email')} name="email" className="mt-[8px] block px-4 w-full bg-transparent border font-noto border-black dark:border-white rounded min-h-[46px] text-black dark:text-white outline-none focus:!border-primary" placeholder="Enter your Email/password " />
              ...
              <div className="mt-[24px]">
                ...
                <div className="relative">
                  <input type="password" {...register('password')} name="password" className="mt-[8px] block px-4 w-full bg-transparent border  font-noto border-black dark:border-white rounded min-h-[46px] text-black dark:text-white outline-none focus:!border-primary" placeholder="Enter your login password" />
              ...
              <div className="mt-[24px]">
                ...
                <div className="relative">
                  <input type="password" {...register('code')} name="code" className="mt-[8px] block px-4 w-full font-noto bg-transparent border  border-border-clr dark:border-white rounded min-h-[46px] text-black dark:text-white outline-none focus:!border-primary" placeholder="Enter your fund code" />
                  <Image src={passShow} alt="" width={16} height={16} className="cursor-pointer absolute top-[50%] right-[20px] translate-y-[-50%] hidden" onClick={(e) => { hidePass(e) }} />
                  <div className="cursor-pointer absolute top-[50%] right-[20px] translate-y-[-50%]" onClick={(e) => { showPass(e) }}>
                    <Icons type='close-eye' />
                  </div>
              ...
              <div className="mt-[24px]">
                ...
                <div className="relative">
                  <input type="password" {...register('confirmcode')} name="confirmcode" className="mt-[8px] block px-4 w-full font-noto bg-transparent border  border-border-clr dark:border-white rounded min-h-[46px] text-black dark:text-white outline-none focus:!border-primary" placeholder="Confirm fund code" />
                  <Image src={passShow} alt="" width={16} height={16} className="cursor-pointer absolute top-[50%] right-[20px] translate-y-[-50%] hidden" onClick={(e) => { hidePass(e) }} />
                  <div className="cursor-pointer absolute top-[50%] right-[20px] translate-y-[-50%]" onClick={(e) => { showPass(e) }}>
                    <Icons type='close-eye' />
                  </div>
