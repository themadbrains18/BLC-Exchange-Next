        ...
        <div className="container m-auto">
            <div className="p-3 sm:p-6 max-w-[500px] w-full mx-auto" >
                ...
                <div className="bg-[#f3f7fe] p-[10px] flex items-center gap-[15px] my-[15px]">
                    ...
                    <div>
                        <p className="info-16">S26EUEZDIULJAJRP</p>
                ...
                <form>
                    ...
                    <button className="cta w-full mt-[15px]" onClick={(e)=>{e.preventDefault();setShow(true)}}>Submit</button>
                </form>
            </div>
        </div>
        {
            show &&
            <VerificationCode CloseCta={true} fixed={true} showState={show} showSetState={setShow} bindGoogle={true} />
        }
    </section>
  )
}
