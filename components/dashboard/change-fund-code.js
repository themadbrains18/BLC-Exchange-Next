                ...
                <div className="p-3 sm:p-6 max-w-[500px] w-full mx-auto" >
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input type="password" className="mt-[8px] block px-4 w-full bg-transparent border  border-black dark:border-white rounded min-h-[46px] text-black dark:text-white outline-none focus:!border-primary" name="email" placeholder="Enter your current fund code" />
