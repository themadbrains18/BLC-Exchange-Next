          ...
          <div className='flex gap-5'>
            <div className='flex flex-col gap-4 mt-6 relative' onClick={(e) => { setShowId(!showId), setRotate(!rotate) }}>
              ...
              <div className='flex border-2 border-border-clr  bg-transparent rounded-lg focus:!border-primary dark:border-white'>
                <input type='text' placeholder='ID Card' autocomplete="off" value={coupon} className=' max-w-fit w-full p-2 -z-10  bg-transparent   text-black dark:text-white outline-none ' />
                <img
            ...
            <div className='flex flex-col gap-4 mt-6 relative' onClick={(e) => { setShowDropdown(!showDropdown), setRotate1(!rotate1) }}>
              ...
              <div className='flex border-2 border-border-clr  bg-transparent rounded-lg focus:!border-primary dark:border-white'>
                <input type='text' placeholder='ID Card' autocomplete="off" value={couponStatus} className=' max-w-fit w-full p-2 -z-10  bg-transparent   text-black dark:text-white outline-none ' />
                <img
                  src="/assets/icons/down.svg"
