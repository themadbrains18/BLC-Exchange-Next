        ...
        <div className="py-20  w-full px-[24px] ">
            <div className="mb-[20px]">
                ...
                <div className="divide-y px-[24px] shadow-lg dark:shadow-[#1da2b41c] rounded-lg	">
                    ...
                    <div>
                        <div className="flex gap-[18px] grow items-center sm:text-start text-center py-[20px]">
            ...
            <div className="divide-y px-[24px] mt-4 shadow-lg dark:shadow-[#1da2b41c] rounded-lg	">
                ...
                <div>
                    ...
                    <div className="flex items-center  flex-row   py-[20px] gap-[20px]">
                        <p className="info-14 dark:text-white text-black hover:!text-black dark:hover:!text-white ">Second confirmation of limit orde</p>
                        <button  >
                            <label
                                className={`relative inline-flex  items-center  cursor-pointer duration-500`}
                            >
