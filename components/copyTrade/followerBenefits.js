...
function FollowerBenefits() {
  return (
    <section className='startTraderPrivilege dark:bg-black  py-10 md:py-20'>
        <div className='container'>
            ...
            <ul className='flex gap-4 md:flex-row flex-wrap' >
                <li className='md:max-w-[385px] w-full p-[30px] bg-[#f9f9f9] dark:bg-black-v-3 rounded-sm flex flex-col'>
                ...
                <li className='md:max-w-[385px] p-[30px] bg-[#f9f9f9] dark:bg-black-v-3 rounded-sm flex flex-col'>
