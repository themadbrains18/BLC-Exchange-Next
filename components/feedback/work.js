      ...
      <div className='container flex flex-col items-center'>
        ...
        <div className={`grid grid-cols-1 sm:grid-cols-3 md:grid-cols-5 mt-12 gap-1 lg:gap-16 w-full ${mode === "dark" ? "qwe" : ""}`}>
          <div className='grid place-items-center'>
            ...
            <div className='hidden md:block bg-gradient-to-r from-[#fff] to-[#1da2b4] h-1 self-end'></div>
        ...
        <p className='mt-16 text-center info-14-16'>Bitget serves users globally, and we regard the safe and stable development of the platform as our top priority. Your valuable feedback helps us improve our product and create a better future together.</p>
