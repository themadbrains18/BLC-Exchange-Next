        ...
        <div className="container">
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="question ">
              ...
              <p className="info-14 font-noto-display md:font-noto  dark:hover:!text-white  md:text-black mt-3 lg:mt-8 lg:max-w-[580px]  lg:w-full dark:!text-white hover:!text-black">
                ...
                nodes. If the total amount verified is greater than or equal to
                100%, then the platform has proven that users' funds are indeed
                intact.
                <br />
            ...
            <div className="grid place-items-center ">
              <Image
                className="lg:max-w-[446px] lg:w-full lg:h-96"
                src={"/assets/images/100percentBanner.png"}
                width={446}
                height={360}
              />
            </div>
          ...
          <div className="flex flex-col-reverse lg:flex-row gap-12 mt-10">
            <div className="grid place-items-center ">
              <Image
                className="lg:max-w-[446px] lg:w-full lg:h-96"
                src={"/assets/images/transparencyBanner.png"}
                width={446}
                height={360}
              />
            </div>
