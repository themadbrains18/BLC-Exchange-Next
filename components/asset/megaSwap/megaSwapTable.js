    ...
    <>
      <div className="overflow-x-auto table_box  ">
        <div className="table mt-4 w-max md:w-full border border-border-clr rounded-sm ">
          ...
          >
            <h4 className="head_col p-3 info-12 text-base dark:text-white">Sell</h4>
            <h4 className="head_col p-3 info-12 text-base dark:text-white">Buy</h4>
            <h4 className="head_col p-3 info-12 text-base dark:text-white">Price</h4>
            <h4 className="head_col p-3 info-12 text-base dark:text-white">Trading Fees</h4>
            <h4 className="head_col p-3 info-12 text-base dark:text-white">Creation time</h4>
