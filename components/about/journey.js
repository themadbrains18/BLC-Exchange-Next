...
const Journey = () => {
  return (
    <section className="bg-primary dark:bg-primary py-[80px] md:py-[120px] md:bg-no-repeat md:bg-center md:bg-[url('/assets/images/journeybg.png')]  ">
    <div className="container my-0 mx-auto ">
        ...
        <div className='text-center mt-5'>
            <button className='px-10 h-[48px] info-14-16 text-black rounded-lg bg-white text-center'>Join Us</button>
        </div>
