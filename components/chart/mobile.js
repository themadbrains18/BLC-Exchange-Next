  ...
  return (
    <>
      <div className="w-full">
        ...
        <BuySellCard show={show} setShow={setShow} active={active} symbol={symbol} usdtBal={usdtAssets.length >0 ? usdtAssets [0].balance : 0} tokenBal={tokenAssets.length >0 ? tokenAssets[0].balance : 0}/>
