                ...
                <div className="flex items-start">
                    <div className="max-w-[200px] w-full md:block hidden">
                        <ul>
                            ...
                            <li className={`${active === 3 ? 'border-r-[4px] border-primary pl-[15px] bg-[#1da2b41f]' : 'pl-[15px]'}`} ><Link className="info-14-16 py-[10px] block" href="" onClick={() => { setActive(3) }}>Post Ad</Link></li>
