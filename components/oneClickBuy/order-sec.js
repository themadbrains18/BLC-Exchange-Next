...
const OrderSec = (props) => {
    ...
    // top of the section timer
    const {initialMinute3 = 6,initialSeconds3 = 59} = props;
    const [ minutes3, setMinutes3 ] = useState(initialMinute3);
    const [seconds3, setSeconds3 ] =  useState(initialSeconds3);
    
    useEffect(()=>{
        let myInterval = setInterval(() => {
                if (seconds > 0 || seconds2 > 0 || seconds3 > 0) {
            ...
            <div className="container">
                <div className='flex items-start justify-between flex-col-reverse md:flex-row gap-5 text-center md:text-left'>
                    <div className='max-w-full md:max-w-[48%] w-full'>
                        <div className="pb-[30px] border-b border-grey">
                            ...
                            <div className='flex items-center gap-[20px]'>
                                ...
                                {/* if order is calcelled this should be showen */}
                                    ...
                                    {/* <p className='info-14 max-w-[50%] w-full hover:!text-grey'>Order is cancelled.Please do not make any payment!</p> */}
                        ...
                        {/* if order is calcelled this should be hidden */}
                            <p className="info-14-16 p-[12px] rounded-md bg-[#8ed0d9] dark:!text-black">Please pay with a payment method enabled in your own name, seller can request a refund or cancel the order.</p>
                        {/* if order is calcelled this should be hidden */}
