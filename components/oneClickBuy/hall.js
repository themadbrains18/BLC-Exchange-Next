            ...
            <div className='grid grid-cols-6 items-center gap-[25px]'>
              {/* buy sell cta's */}
                ...
                <div className="flex items-center gap-[20px]">
                  ...
                  <label class="relative inline-flex  items-center mr-5 cursor-pointer duration-500">
                     <input type="checkbox" class="sr-only peer" value="" />
                      <div class="-z-[1] duration-500 w-9 h-5 bg-gray-200 rounded-full peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all dark:border-gray-600 peer-checked:bg-primary border-gray-600" ></div>
                  </label> 
                </div>
                {/* Search dropdown */}
                <div className="border rounded-md border-border-clr">
