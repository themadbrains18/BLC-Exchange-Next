                  ...
                  <tr className="border-b border-grey">
                      ...
                      <td>
                          ...
                          <div className="my-[24px] grow-[0.6]">
                            <button className="cta min-w-[100px] w-full" onClick={()=>{showPopup(true);setClick(true)}}>Buy</button>
                          </div>
                      </td>
                  </tr>
                  <tr className="border-b border-grey">
              ...
              <div className="max-w-[40%] hidden lg:block w-full p-[22px] bg-white dark:bg-hover-black dark:shadow-none shadow-md">
                    ...
                    <div className="my-[24px] flex items-center gap-[10px] grow-[1.6]">
                      <div className="min-w-[38px] min-h-[38px] rounded-full bg-[#e8f6f7] flex">
                        <span className="m-auto text-primary dark:text-primary info-14-16">N</span>
                      </div>
                      <div className="">
                        <p className="info-14 !text-black hover:!text-black dark:!text-white">Nino's</p>
                  ...
                  <div className="flex items-center justify-between mb-[15px]">
                    ...
                    <p className="info-14 !text-primary">1.030 USD</p>
                  </div>
                  <div className="flex items-center justify-between mb-[15px]">
