        ...
        <section className="py-10 lg:pb-20 dark:bg-black">
            <div className='container  text-left lg:flex flex-row-reverse justify-between items-center'>
                ...
                <div className='w-full  lg:w-[50%]'>
                    <h1 className=' text-[32px] font-noto-display dark:text-white  lg:text-[56px] text-[#1e1e1e] font-medium lg:w-[600px]'>Complete tasks to earn up to <span className='text-[#1da2b4]'>5,005</span> USDT </h1>
