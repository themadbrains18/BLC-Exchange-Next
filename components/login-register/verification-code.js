                                ...
                                {loginData.email !== "" &&
                                    <div className='mt-5'>
                                        ...
                                        <div className="grid grid-cols-6 justify-between gap-[8px] sm:gap-[20px] input_wrapper input_wrapper_email">
                                            ...
                                            <input type="number" className="block px-2 md:px-4w-[46px] dark:bg-black bg-transparent border  border-black dark:border-white rounded min-h-[46px] text-black dark:text-white outline-none focus:!border-primary" name="code4" />
