  ...
  return (
    <section className='dark:bg-black-v-5 py-[80px] !pt-[120px] lg:!pt-[204px]'>
        <div className='container'>
            {/* login part */}
            <div className='p-3 sm:p-6 border border-grey max-w-[480px] w-full m-auto'>
                <h4 className='section-secondary-heading mb-5'>Welcome back</h4>
                <div className='flex gap-8 mb-8'> 
                    <button className={`info-14 border-b-2 border-transparent pb-1  ${show === 1 ? " !border-primary" : ""}`} onClick={()=>{setShow(1)}}>Email / Mobile number</button>
                    <button className={`info-14 border-b-2 border-transparent pb-1 pb-1${show === 2 ? " !border-primary" : ""}`} onClick={()=>{setShow(2)}}>QR code</button>
                </div>
                ...
                <p className='flex gap-3 justify-center'>
                    <span className='info-14'>Don't have an account?</span>
