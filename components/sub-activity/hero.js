        ...
        <section className='dark:bg-black py-10 md:py-20 '>
            <div className="container">
                <div className='flex items-center justify-between flex-col-reverse md:flex-row gap-5 text-center md:text-left'>
                    ...
                    <p className='info-14-20 mt-6 md:mt-10'>Participate in GroupCoin and get up to<span className="!text-[40px] leading-[50px] !text-primary"> 50% </span>off featured crypto</p>
                    </div>
